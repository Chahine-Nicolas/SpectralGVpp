...
tf_neighbors_module = tf.load_op_library(os.path.abspath(os.path.join(os.path.dirname(__file__), '../tf_custom_ops/tf_neighbors.so')))
tf_batch_neighbors_module = tf.load_op_library(os.path.abspath(os.path.join(os.path.dirname(__file__),'../tf_custom_ops/tf_batch_neighbors.so')))
tf_subsampling_module = tf.load_op_library(os.path.abspath(os.path.join(os.path.dirname(__file__),'../tf_custom_ops/tf_subsampling.so')))
tf_batch_subsampling_module = tf.load_op_library(os.path.abspath(os.path.join(os.path.dirname(__file__),'../tf_custom_ops/tf_batch_subsampling.so')))
